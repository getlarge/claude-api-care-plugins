// @getlarge/aip-openapi-reviewer-mcp worker v1.0.0
...
var require_schema2 = __commonJS({
  "../../../node_modules/yaml/dist/schema/json/schema.js"(exports) {
    ...
    var schema = [map2.map, seq2.seq].concat(jsonScalars, jsonError);
    exports.schema = schema;
  }
});
  ...
  "../../../node_modules/yaml/dist/schema/yaml-1.1/timestamp.js"(exports) {
    ...
    var timestamp = {
      ...
      resolve(str) {
        ...
        let date = Date.UTC(year, month2 - 1, day, hour || 0, minute || 0, second || 0, millisec);
        const tz = match2[8];
        if (tz && tz !== "Z") {
...
function parseSpecFromBuffer(buffer, contentType) {
  ...
  const spec = contentType === "yaml" ? (0, import_yaml.parse)(text) : JSON.parse(text);
